...
function getRadarDataPoints(r, o, n, a, t) {
  ...
  for (let e = 0; e < a.length; e++) {
    ...
    t.data.forEach(function (t, e) {
      ...
      a.proportion = t / s;
      a.value = t;
      a.position = convertCoordinateOrigin(n * a.proportion * l * Math.cos(a.angle), n * a.proportion * l * Math.sin(a.angle), o);
      i.data.push(a)
    });
    h.push(i)
  }
...
function drawToolTipBridge(t, e, a, i, r, o) {
  ...
  if (n.horizentalLine && t.tooltip && i === 1 && (t.type == "line" || t.type == "area" || t.type == "column" || t.type == "mount" || t.type == "candle" || t.type == "mix")) {
    ...
    if (c._xAxisTextAngle_ === 0) {
      a.forEach(function (t, e) {
        ...
        if (n - Math.abs(o) >= h.area[3] - 1 && n - Math.abs(o) <= h.width - h.area[1] + 1) {
          ...
          d.fillText(String(a), x[e] + i, u + h.xAxis.marginTop * h.pix + (h.xAxis.lineHeight - h.xAxis.fontSize) * h.pix / 2 + h.xAxis.fontSize * h.pix);
          d.closePath();
          d.stroke()
        }
      })
    ...
    for (let e = 0; e < h.yAxis.data.length; e++) {
      ...
      if (s.disabled !== true) {
        ...
        if (h.yAxis.showTitle) {
          ...
          if (n.position == "left") {
            c.fillText(e, d - measureText(e, t, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix)
          } else if (n.position == "right") {
            c.fillText(e, x - measureText(e, t, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix)
          } else if (n.position == "center") {
            c.fillText(e, f - measureText(e, t, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix)
          }
          c.closePath();
          c.stroke()
        }
...
function drawArcbarDataPoints(a, i, t, r) {
  ...
  for (let e = 0; e < a.length; e++) {
    ...
    r.beginPath();
    if (o.type == "default") {
      r.arc(n.x, n.y, l - (o.width * i.pix + o.gap * i.pix) * e, o.startAngle * Math.PI, o.endAngle * Math.PI, o.direction == "ccw")
    } else {
    ...
    r.setLineCap(o.lineCap);
    r.beginPath();
    r.arc(n.x, n.y, l - (o.width * i.pix + o.gap * i.pix) * e, o.startAngle * Math.PI, t._proportion_ * Math.PI, o.direction == "ccw");
    r.stroke()
  }
  ...
  for (let i = 0; i < l.length; i++) {
    ...
    if (l[i].rotate) {
      if (l[i].areav[0] > 0) {
        if (r.tooltip) {
          if (r.tooltip.index == i) {
            o.strokeText(t, (l[i].areav[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].areav[1] + 5 + e - r.height / 2) * n)
          } else {
            o.fillText(t, (l[i].areav[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].areav[1] + 5 + e - r.height / 2) * n)
          }
        } else {
          o.fillText(t, (l[i].areav[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].areav[1] + 5 + e - r.height / 2) * n)
        }
      ...
      if (l[i].area[0] > 0) {
        if (r.tooltip) {
          if (r.tooltip.index == i) {
            o.strokeText(t, (l[i].area[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].area[1] + 5 + e - r.height / 2) * n)
          } else {
            o.fillText(t, (l[i].area[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].area[1] + 5 + e - r.height / 2) * n)
          }
        } else {
          o.fillText(t, (l[i].area[0] + 5 - r.width / 2) * n - a * (1 - n) / 2, (l[i].area[1] + 5 + e - r.height / 2) * n)
        }
  ...
  if (i.type == "pyramid") {
    ...
    for (let t = 0; t < l.length; t++) {
      if (t == l.length - 1) {
        ...
        l[t].funnelArea = [o.x - l[t].radius, o.y - r * (l.length - t), o.x + l[t].radius, o.y - r * (l.length - t - 1)];
        a.beginPath();
        a.setLineWidth(i.borderWidth * e.pix);
        a.setStrokeStyle(i.borderColor);
        var s = hexToRgb(l[t].color, i.fillOpacity);
...
uCharts.prototype.showToolTip = function (t) {
  ...
  if (this.opts.type === "mount") {
    ...
    if (o > -1) {
      ...
      var s = [{
        ...
        color: n.color,
        legendShape: this.opts.extra.tooltip.legendShape == "auto" ? n.legendShape : this.opts.extra.tooltip.legendShape
      }];
      var h = {
  ...
  if (this.opts.type === "candle") {
    ...
    if (o > -1) {
      ...
      var n = getSeriesDataItem(this.opts.series, o);
      if (n.length !== 0) {
        var l = getCandleToolTipData(this.opts.series[0].data, n, this.opts, o, this.opts.categories, this.opts.extra.candle, e),
          s = l.textList,
          h = l.offset;
        h.y = a.y;
        i.tooltip = {
      ...
      if (n.length !== 0) {
        var s = n.map(t => {
          return {
            ...
            color: t.color,
            legendShape: this.opts.extra.tooltip.legendShape == "auto" ? t.legendShape : this.opts.extra.tooltip.legendShape
          }
        });
        var h = {
          x: a.x,
